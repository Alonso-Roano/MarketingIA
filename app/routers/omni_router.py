    ...
    try:
        result, new_token = crear_project_prediction(
            ...
            body = {
                ...
                "no_of_days": round(int(interpretaciones["marketing_no_days"]["prediccion"])),
                ...
                "impressions": round(int(interpretaciones["marketing_impressions"]["prediccion"])),
                "clicks": round(int(interpretaciones["marketing_clicks"]["prediccion"])),
